...
## Step1 Reading and processing the New York Times (NYT) state-level COVID-19 data
```{r}
...
## Step4 Add new_cases and new_deaths and correct outliers
```{r}
...
cv_states_today_filter %>% 
  plot_ly(x = ~pop_density, y = ~deathsper100k,
          ...
          text = ~paste( paste(state, ":", sep=""), paste(" Cases per 100k: ", per100k, sep="") , 
                         paste(" Deaths per 100k: ", deaths, sep=""), sep = "<br>")) %>%
